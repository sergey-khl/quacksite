      ...
      <Container>
        ...
        <Row>
          ...
          <Col>
            ...
            <img width="750" height="60%" src="DUCK.jpg" className="img-fluid" alt="Responsive image"></img>
          </Col>
          <Col>
          ...
          <Col>
            ...
            <img src="duck_hello.png" className="img-fluid" alt="Responsive image"></img>
          </Col>
        </Row>
        <Row>
        ...
        <Row>
          ...
          <Col>
            ...
            <img width="750" height="60%" src="color_detect.png" className="img-fluid" alt="Responsive image"></img>
          </Col>
          <Col>
            <h4>
            ...
            <img width="750" height="60%" src="dashboard.png" className="img-fluid" alt="Responsive image"></img>
          </Col>
        </Row>
      </Container>
    </div>
